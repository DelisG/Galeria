<div align="center"> 
<img src="https://cdn-icons-png.flaticon.com/512/1375/1375106.png" width="170px">
<h1>Projeto Galeria</h1>
</div>

[![Status do Projeto](https://img.shields.io/badge/Status-Em_Desenvolvimento-brightgreen?color=blue)](#)


## Visão Geral do Projeto

O Projeto Galeria é uma aplicação FullStack desenvolvida em JavaScript com Node.js e a arquitetura MVC. Ele oferece uma interface para manipular dados da API, exibindo fotos com descrição, data e opção de exclusão. Os usuários também podem adicionar novas fotos diretamente do site, proporcionando uma experiência completa de gerenciamento de galerias de forma prática e intuitiva.
